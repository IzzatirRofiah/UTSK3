        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 mx-auto text-center" data-aos="fade-up">
                    ...
                    <p class="lead">Memahami berbagai faktor yang mempengaruhi keselamatan dan kesehatan kerja di lingkungan bengkel mobil</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="card card-modern mb-5" data-aos="fade-up">
                        <div class="card-body p-5">
                            <h3 class="card-title mb-4">Faktor-Faktor yang Berpengaruh Terhadap Keselamatan Kerja</h3>
                            <p class="card-text">
                                Dalam kegiatan service mobil di bengkel, terdapat berbagai faktor yang mempengaruhi penerapan 
                                Keselamatan dan Kesehatan Kerja (K3). Faktor-faktor ini penting untuk memastikan pekerja, 
                                pelanggan, serta aset perusahaan terlindungi dari potensi kecelakaan dan kerugian.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="card card-modern h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h5 class="card-title">Tata Letak dan Zonasi</h5>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="card card-modern h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h5 class="card-title">Manajemen Limbah B3</h5>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                            <div class="card card-modern h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h5 class="card-title">Kesiapan Keadaan Darurat</h5>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                            <div class="card card-modern h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h5 class="card-title">Keamanan Lingkungan</h5>
